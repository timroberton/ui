...
export default function AlertProvider(_a) {
    ...
    return (_jsxs(Context.Provider, __assign({ value: { openAlert: openAlert, openConfirm: openConfirm, openPrompt: openPrompt, openComponent: openComponent } }, { children: [children, _jsxs(Dialog, __assign({ open: !!alertState, onClose: cancelAny, className: "relative z-50" }, { children: [_jsx("div", { className: "fixed inset-0 bg-black/30", "aria-hidden": "true" }), _jsx("div", __assign({ className: "fixed inset-0 flex items-center justify-center p-4" }, { children: _jsx(Dialog.Panel, __assign({ className: "mx-auto max-w-lg rounded bg-base-100 px-10 py-8" }, { children: (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "component" ? (_jsx(alertState.element, __assign({ close: function (p) {
                                    setAlertState(undefined);
                                    alertState.componentResolver(p);
                                } }, alertState.elementProps))) : (_jsxs(_Fragment, { children: [(alertState === null || alertState === void 0 ? void 0 : alertState.title) && (_jsx(Dialog.Title, __assign({ className: "mb-2 text-lg font-700 ".concat((alertState === null || alertState === void 0 ? void 0 : alertState.intent) === "danger" ? "text-error" : "") }, { children: alertState.title }))), (alertState === null || alertState === void 0 ? void 0 : alertState.text) && _jsx("p", __assign({ className: "mb-4" }, { children: alertState === null || alertState === void 0 ? void 0 : alertState.text })), (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "alert" && (_jsx("div", __assign({ className: "" }, { children: _jsx(Button, __assign({ onClick: function () {
                                                setAlertState(undefined);
                                                alertState.alertResolver();
                                            }, intent: alertState.intent }, { children: (_b = alertState.closeButtonLabel) !== null && _b !== void 0 ? _b : "Close" })) }))), (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "confirm" && (_jsxs("div", __assign({ className: "" }, { children: [_jsx(Button, __assign({ onClick: function () {
                                                    setAlertState(undefined);
                                                    alertState.confirmResolver(true);
                                                }, intent: alertState.intent }, { children: (_c = alertState.confirmButtonLabel) !== null && _c !== void 0 ? _c : "Confirm" })), _jsx(Button, __assign({ onClick: function () {
                                                    setAlertState(undefined);
                                                    alertState.confirmResolver(false);
                                                }, intent: "neutral", margin: "left" }, { children: "Cancel" }))] }))), (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "prompt" && (_jsx(_Fragment, { children: _jsxs("form", __assign({ id: "promptForm", className: "" }, { children: [_jsx("div", __assign({ className: "mb-4 w-96" }, { children: alertState.inputLabel ? (_jsx(InputWithLabel, { rootId: "prompt-input", label: alertState.inputLabel, type: (_d = alertState.inputType) !== null && _d !== void 0 ? _d : "text", value: promptInput, onChange: function (v) { return setPromptInput(v.target.value); }, autoFocus: true })) : (_jsx(Input, { type: (_e = alertState.inputType) !== null && _e !== void 0 ? _e : "text", value: promptInput, onChange: function (v) { return setPromptInput(v.target.value); }, autoFocus: true })) })), _jsxs("div", __assign({ className: "" }, { children: [_jsx(Button, __assign({ type: "submit", form: "promptForm", onClick: function () {
                                                                setAlertState(undefined);
                                                                alertState.promptResolver(promptInput);
                                                            }, intent: alertState.intent }, { children: (_f = alertState.saveButtonLabel) !== null && _f !== void 0 ? _f : "Confirm" })), _jsx(Button, __assign({ type: "button", onClick: function () {
                                                                setAlertState(undefined);
                                                                alertState.promptResolver(undefined);
                                                            }, intent: "neutral", margin: "left" }, { children: "Cancel" }))] }))] })) }))] })) })) }))] }))] })));
}
