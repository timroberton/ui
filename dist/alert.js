...
export default function AlertProvider(_a) {
    ...
    return (_jsxs(Context.Provider, __assign({ value: { openAlert: openAlert, openConfirm: openConfirm, openPrompt: openPrompt, openComponent: openComponent } }, { children: [children, _jsxs(Dialog, __assign({ open: !!alertState, onClose: cancelAny, className: "relative z-50" }, { children: [_jsx("div", { className: "fixed inset-0 bg-black/30", "aria-hidden": "true" }, void 0), _jsx("div", __assign({ className: "fixed inset-0 flex items-center justify-center p-4" }, { children: _jsx(Dialog.Panel, __assign({ className: "mx-auto max-w-lg rounded bg-base-100 px-10 py-8" }, { children: (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "component" ? (_jsx(alertState.element, __assign({ close: function (p) {
                                ...
                                } }, alertState.elementProps), void 0)) : (_jsxs(_Fragment, { children: [(alertState === null || alertState === void 0 ? void 0 : alertState.title) && (_jsx(Dialog.Title, __assign({ className: "mb-2 text-lg font-700 " + ((alertState === null || alertState === void 0 ? void 0 : alertState.intent) === "danger" ? "text-error" : "") }, { children: alertState.title }), void 0)), (alertState === null || alertState === void 0 ? void 0 : alertState.text) && _jsx("p", __assign({ className: "mb-4" }, { children: alertState === null || alertState === void 0 ? void 0 : alertState.text }), void 0), (alertState === null || alertState === void 0 ? void 0 : alertState.stateType) === "alert" && (_jsx("div", __assign({ className: "" }, { children: _jsx(Button, __assign({ onClick: function () {
                                                setAlertState(undefined);
                                                alertState.alertResolver();
