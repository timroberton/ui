...
export function Checkbox(_a) {
    ...
    return (_jsx(Switch, __assign({ checked: checked, onChange: onChange, as: Fragment }, { children: function (_a) {
            ...
            return (_jsx("button", __assign({ className: getClassesForCheckbox({ checked: checked, intent: intent }) }, { children: _jsx("span", { className: (checked ? "translate-x-6" : "translate-x-1") + " inline-block h-4 w-4 transform rounded-[9999px] bg-white transition" }, void 0) }), void 0));
        } }), void 0));
}
export function CheckboxWithLabel(_a) {
    ...
    return (_jsx(Switch.Group, { children: _jsxs("div", __assign({ className: "flex items-center" }, { children: [labelOnLeft && _jsx(Switch.Label, __assign({ className: "mr-2" }, { children: label }), void 0), _jsx(Checkbox, { intent: intent, checked: checked, onChange: onChange }, void 0), !labelOnLeft && _jsx(Switch.Label, __assign({ className: "ml-2" }, { children: label }), void 0)] }), void 0) }, void 0));
}
