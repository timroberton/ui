...
export function Select(_a) {
    ...
    return (_jsx(Listbox, __assign({ value: selected, onChange: onChange }, { children: _jsxs("div", __assign({ className: "relative" }, { children: [label &&
                    _jsx(Listbox.Label, __assign({ className: "text-base-content-lighter block text-sm mb-1" }, { children: label }), void 0), _jsxs(Listbox.Button, __assign({ className: getClassesForSelect({ intent: intent }) }, { children: [_jsx("span", __assign({ className: "block truncate" }, { children: selectedFull === null || selectedFull === void 0 ? void 0 : selectedFull.text }), void 0), _jsx("span", __assign({ className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2" }, { children: _jsx(ChevronUpDownIcon, { className: "h-5 w-5 text-gray-400", "aria-hidden": "true" }, void 0) }), void 0)] }), void 0), _jsx(Listbox.Options, __assign({ className: "absolute mt-1 max-h-60 w-full overflow-auto rounded bg-white py-1 text-base-content focus-visible:outline-none z-10" }, { children: options.map(function (opt) { return (_jsx(Listbox.Option, __assign({ className: function (_a) {
                            var active = _a.active;
                            return "relative cursor-pointer select-none py-2 pl-10 pr-4 " + (active ? "bg-base-200 text-base-content" : "text-base-content-lighter");
                        }, value: opt.key }, { children: function (_a) {
                            var selected = _a.selected, active = _a.active;
                            return (_jsxs(_Fragment, { children: [_jsx("span", __assign({ className: "block truncate font-400 " + ((selected || active) ? "text-base-content" : "text-base-content-lighter") }, { children: opt.text }), void 0), selected ? (_jsx("span", __assign({ className: "absolute inset-y-0 left-0 flex items-center pl-3 text-base-content" }, { children: _jsx(CheckIcon, { className: "h-5 w-5", "aria-hidden": "true" }, void 0) }), void 0)) : null] }, void 0));
                        } }), opt.key)); }) }), void 0)] }), void 0) }), void 0));
}
