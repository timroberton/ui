...
export function LoginPage(p) {
    ...
    return (_jsx("main", __assign({ className: "flex h-screen w-screen items-start justify-center" }, { children: _jsxs("div", __assign({ className: "bg-base-200 mt-24 rounded py-10 px-12" }, { children: [p.logoLinkElement && (_jsx("div", __assign({ className: "w-full text-center" }, { children: p.logoLinkElement }), void 0)), p.showResetPasswordForm ? (_jsx(ResetPasswordForm, { changeLoginViewState: function (v) { return setLoginViewState(v); }, supabase: p.supabase, resetPasswordRedirectUrl: p.resetPasswordRedirectUrl, cancelResetPasswordForm: p.cancelResetPasswordForm }, void 0)) : (_jsxs(_Fragment, { children: [loginViewState === "signin" && (_jsx(SignInForm, { changeLoginViewState: function (v) { return setLoginViewState(v); }, supabase: p.supabase }, void 0)), loginViewState === "register" && (_jsx(RegisterForm, { changeLoginViewState: function (v) { return setLoginViewState(v); }, supabase: p.supabase }, void 0)), loginViewState === "resetpasswordrequest" && (_jsx(ResetPasswordRequest, { changeLoginViewState: function (v) { return setLoginViewState(v); }, supabase: p.supabase, resetPasswordRedirectUrl: p.resetPasswordRedirectUrl }, void 0))] }, void 0))] }), void 0) }), void 0));
}
