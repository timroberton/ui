...
function ResetPasswordRequest(p) {
    ...
    return (_jsxs("form", __assign({ id: "resetPasswordRequestForm", className: "space-y-4" }, { children: [_jsx(FormHeader, { children: "Reset your password" }), rprViewState === "finishedsending" ? (_jsx("div", __assign({ className: "text-center" }, { children: "Email sent! Check your email for a link to reset your password." }))) : rprViewState === "sending" ? (_jsx("div", __assign({ className: "text-center" }, { children: "Sending email..." }))) : (_jsxs(_Fragment, { children: [_jsx("div", __assign({ className: "text-sm text-base-content-lighter" }, { children: "Send a link to your email account, which you can use to reset your password." })), _jsx(InputWithLabel, { rootId: "email", label: "Email", type: "email", autoComplete: "email", value: email, onChange: function (v) { return setEmail(v.target.value); }, autoFocus: true }), _jsx(Button, __assign({ className: "w-full", onClick: submit, type: "submit", form: "resetPasswordRequestForm" }, { children: "Send email" })), errorMsg && _jsx("div", __assign({ className: "text-center text-error" }, { children: errorMsg })), _jsx(SpanButton, __assign({ onClick: function () { return p.changeLoginViewState("signin"); } }, { children: "Remember your password?" }))] }))] })));
}
...
function SpanButton(p) {
    return (_jsx("div", __assign({ className: "text-center" }, { children: _jsx("span", __assign({ className: "cursor-pointer text-sm text-base-content-lighter hover:underline", onClick: p.onClick }, { children: p.children })) })));
}
function FormHeader(p) {
    return (_jsx("div", __assign({ className: "text-center text-lg font-700 text-primary" }, { children: p.children })));
}
